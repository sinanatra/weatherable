      ...
      <div class="comparison">
        <ul class="comparison-list">
          ...
          <li>
            ...
            <span class="guessed"
              >{parseInt(mapValue(guessedData?.temp, 0.1, 1, 0, 40))}°</span
            >
          ...
          <li>
            ...
            <span class="guessed"
              >{parseInt(mapValue(guessedData?.uv, 0.1, 1, 0, 11))}</span
            >
          ...
          <li>
            ...
            <span class="guessed"
              >{parseInt(mapValue(guessedData?.wrain_piezo, 0.1, 1, 0, 100))} mm/h</span
            >
            <span class="real"> {averages.wrain_piezo.toFixed(2)} mm/h</span>
          </li>
          <li>
            <span class="label">Humidity:</span>
            <span class="guessed"
              >{parseInt(mapValue(guessedData?.humidity, 0.1, 1, 0, 100))} %</span
            >
            <span class="real"> {averages.humidity.toFixed(2)} %</span>
          </li>
          <li>
            <span class="label">Wind:</span>
            <span class="guessed"
              >{parseInt(mapValue(guessedData?.windspeed, 0.1, 1, 0, 70))} m/s</span
            >
            <span class="real"> {averages.windspeed.toFixed(2)} m/s</span>
          </li>
        </ul>
      </div>
