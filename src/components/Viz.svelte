<script>
    ...
    let canvas;
    let context;
    let width = 377; // Desired display width in CSS pixels
    let height = 75; // Desired display height in CSS pixels
    ...
    onMount(() => {
        ...
        // Set the desired canvas resolution
        const scaleFactor = 5; // Use higher scale factor for higher resolution
        ...
        canvas.style.height = `${height}px`; // Display size
